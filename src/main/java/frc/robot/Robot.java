...
/**
  ...
  public void teleopPeriodic() {
    ...
    MainCompressor.setClosedLoopControl(true);
    MainCompressor.start();
    /*SmartDashboard.putNumber("y", Robot.m_oi.XBOX.getX(Hand.kLeft) * 1.3);
    SmartDashboard.putNumber("x", Robot.m_oi.XBOX.getY(Hand.kLeft) * -1);
    SmartDashboard.putNumber("other x", Robot.m_oi.XBOX.getX(Hand.kRight) * 0.5)
    System.out.println(Robot.m_oi.XBOX.getX(Hand.kLeft) * 1.3);
    */
  }
  /**
