...
public void initDefaultCommand() {
    ...
    public void TeleopDrive(double ymovement, double xmovement, double rotatemovement) {
        ...
        frontRightMotorSpeed = ymovement + xmovement + rotatemovement;
        frontLeftMotorSpeed = ymovement - xmovement + rotatemovement;
        rearRightMotorSpeed = ymovement - xmovement - rotatemovement;
        rearLeftMotorSpeed = ymovement + xmovement - rotatemovement;

       

        frontRightMotor.set(frontRightMotorSpeed * -1);
        frontLeftMotor.set(frontLeftMotorSpeed * -1);
        rearRightMotor.set(rearRightMotorSpeed);
        rearLeftMotor.set(rearLeftMotorSpeed);
